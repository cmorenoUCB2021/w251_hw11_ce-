...
class DQN:
    ...
    def initialize_model(self):
        ...
        model.add(Dense(self.density_four_layer, activation=relu))
        model.add(Dense(self.density_five_layer, activation=relu))
        model.add(Dense(self.density_six_layer, activation=relu))
...
#    print("Total tests above 200: ", high_score)
    ...
    model.save('/tmp/videos/mymodel-' + dt + '.h5')
